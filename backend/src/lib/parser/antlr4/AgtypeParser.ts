...
export class AgtypeParser extends Parser {
  ...
  public floatLiteral(): FloatLiteralContext {
    const _localctx: FloatLiteralContext = new FloatLiteralContext(
      this._ctx,
      this.state,
    );
  ...
  public static get _ATN(): ATN {
    if (!AgtypeParser.__ATN) {
      AgtypeParser.__ATN = new ATNDeserializer().deserialize(
        Utils.toCharArray(AgtypeParser._serializedATN),
      );
    }
